...
#include "Slasher/FloatingPlatform.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SLASHER_API UClass* Z_Construct_UClass_AFloatingPlatform_NoRegister();
	SLASHER_API UClass* Z_Construct_UClass_AFloatingPlatform();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Distance_MetaData[] = {
		{ "Category", "Platform" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Distance = { "Distance", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloatingPlatform, Distance), METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Distance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Distance_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFloatingPlatform_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Distance,
	...
	IMPLEMENT_CLASS(AFloatingPlatform, 3337718630);
	template<> SLASHER_API UClass* StaticClass<AFloatingPlatform>()
	{
		return AFloatingPlatform::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFloatingPlatform(Z_Construct_UClass_AFloatingPlatform, &AFloatingPlatform::StaticClass, TEXT("/Script/Slasher"), TEXT("AFloatingPlatform"), false, nullptr, nullptr, nullptr);
